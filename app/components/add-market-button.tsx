        ...
        <>
            {variant === "nav" ? (
                <button
                    ...
                    className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-200 hover:text-zinc-950 cursor-pointer"
                    aria-label="Request a market"
                    title="Request a market"
                >
                    <span className="inline-flex h-4 w-4 items-center justify-center rounded-full border border-zinc-500 text-xs">
                        +
                    </span>
                ...
                <button
                    type="button"
                    onClick={() => setOpen(true)}
                    className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-zinc-200 bg-sky-400 text-xl font-semibold text-zinc-900 shadow-sm transition hover:bg-zinc-200 cursor-pointer"
                    aria-label="Request a market"
                    title="Request a market"
                >
                    +
